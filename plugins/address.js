...
function getAddressFromPublic(accountPublicKeyBytes, prefix = "paw") {
...
// Extract paw address candidate from string, return null if not found
function extractAddress(rawString) {
    let pattern = new RegExp("(xrb|nano|paw)(_)(1|3)[13456789abcdefghijkmnopqrstuwxyz]{59}", "g");
...
export function validateAddress(address) {
    if (typeof address != "string") {
        ...
        return false
    } else if (!address.startsWith("paw_") && !address.startsWith("xrb_")) {
        return false
    }
